...
$sentencia = $base_de_datos->prepare("SELECT id_venta, fecha, total FROM venta WHERE id_venta = ?");
...
$sentenciaProductos = $base_de_datos->prepare("SELECT comida.id_comida, comida.nombre,comida.precio, comida_vendida.cantidad
FROM comida 
INNER JOIN 
comida_vendida
ON comida.id_comida = comida_vendida.id_comida
WHERE comida_vendida.id_venta = ?");
